...
function string(o) {
    ...
    if (arguments.length>1 && typeof(arguments[1])=="number") {
        ...
        if (arguments.length>1) {
            ...
            for (var j=listIndex; j<list.length; j++) {
                if (properties === null) {
                    properties = {};
                }
                properties[list[j]]=1;
     ...
     if (typeof(o)=="object") {
         if (typeof(o.length)=="number" ) {
             ...
             ret = "[";
                         ...
                         var count = 0;
                         for (var k in o) {
                                 if (o==object && properties!==null && properties[k]!=1) {
                                         // do nothing with this node
                                 }
                                 else {
                                         if (typeof(o[k]) != "unknown") {
                                                 ...
                                                 if (o.ownerDocument|| o.tagName || (o.nodeType && o.nodeName)) {
                                                         ...
                                                         if (k=="tagName" || k=="nodeName" || k=="nodeType" || k=="id" || k=="className") {
                                                 ...
                                                 if (processAttribute) {
                                                         ...
                                                         ret += "'" + k + "' => " + string(o[k],level+1,indentLevel-0+k.length+6+indent);
                                                 }
                                         }
                                 }
                         }
