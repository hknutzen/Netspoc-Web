 ...
 * Each renderer is registered with an xtype, and is used if the
 * component to print has that xtype.
 * 
 * See the files in the renderers directory to customise or to provide
 * your own renderers.
 * 
 * Usage example:
 * 
...
Ext.ux.Printer = function() {
	 ...
	 * @property renderers
	 * @type Object
	 * An object in the form {xtype: RendererClass} which is manages 
	 * the renderers registered by xtype
	 */
	renderers: {},
	 ...
	 * @param {Function} renderer The renderer to invoke for components
	 * of this xtype
	 */
...
Ext.ux.Printer.BaseRenderer = Ext.extend(Object, {
  ...
  print: function(component) {
      ...
      var name = component && component.getXType
          ? String.format("print_{0}_{1}", component.getXType(), comp_id.replace(/-/g, "_") )
          : "print";
